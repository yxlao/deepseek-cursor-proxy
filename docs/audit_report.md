...
**Date:** 2026-05-01
**Scope:**
- Protocol reference: [`docs/thinking-mode-tool-call-flow.md`](thinking-mode-tool-call-flow.md) (mirroring <https://api-docs.deepseek.com/guides/thinking_mode>)
...
concrete claim in `docs/thinking-mode-tool-call-flow.md`. Specific citations
